...
class Email(AuditMixin, Base):
    ...
    in_reply_to: Mapped[Optional[str]] = mapped_column(String, default=None, index=True)
    thread_id: Mapped[Optional[str]] = mapped_column(String, default=None, index=True)
