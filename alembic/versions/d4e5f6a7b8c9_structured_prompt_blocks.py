...
DEFAULT_INITIAL_EMAIL_BLOCKS = {
    ...
    "value_proposition": (
        ...
        "Score 7+ requires the email to surface specific data the recipient likely does not already have - proprietary survey results, "
        "competitive intelligence (e.g. competitor campus spend or brand recall gaps), quantified opportunity gaps (e.g. redemption rates, "
        "market share data, uncontested territories), or conversion benchmarks that reframe the recipient's situation. "
        "An email that leads with a data point the prospect didn't know and connects it to a clear opportunity is an 8-9.\n"
    ...
    "personalisation": (
        ...
        "Genuine personalisation includes: the recipient's specific competitive position (market share, brand recall vs competitors), "
        "their current campus or channel activity (or notable absence of it), category-specific data about their customers' behaviour, "
        "or references to their public strategy, recent campaigns, or announced priorities. "
        "Well-known companies face a higher bar: mentioning what they obviously do is not personalisation. "
        "Score 7+ only if the email demonstrates research that goes beyond the company homepage - e.g. proprietary data about the prospect's customers, "
        "competitive benchmarking, or specific knowledge of their market position.\n"
